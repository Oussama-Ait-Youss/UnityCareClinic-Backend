...
if (isset($_GET['id'])) {
    ...
    // STEP 1: Check if there are doctors assigned to this department
    ...
    // STEP 2: Logic Decision
    if ($doctor_count > 0) {
        // SCENARIO A: Doctors exist. CANNOT DELETE.
        echo "<script>
        ...
        // SCENARIO B: No doctors. Safe to delete.
