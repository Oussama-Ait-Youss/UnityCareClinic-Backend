...
$headerTitle = $t['doctors_management'] ?? 'Doctors Management';
?>
    ...
    <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
        ...
        <div class="relative w-full md:w-48">
            <select class="block w-full pl-3 pr-10 py-3 text-base border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-xl bg-white shadow-sm appearance-none cursor-pointer">
                <option value=""><?php echo $t['all_departments'] ?? 'All Departments'; ?></option>
    ...
    <table class="w-full text-left border-collapse">
        <thead>
            <tr class="text-xs text-gray-400 uppercase border-b border-gray-100">
                ...
                <th class="py-3 font-semibold"><?php echo $t['specialty'] ?? 'Specialty'; ?></th>
                <th class="py-3 font-semibold"><?php echo $t['departments']; ?></th>
        ...
        <div class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
            ...
            <form action="save_doctor.php" method="POST" id="doctorForm">
                <div class="bg-white px-8 pt-8 pb-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-6" id="modalTitle"><?php echo $t['modify_doctor'] ?? 'Modify Doctor'; ?></h3>
                    <input type="hidden" name="id" id="doctorId">
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['first_name'] ?? 'First Name'; ?></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['last_name'] ?? 'Last Name'; ?></label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['email']; ?></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['phone']; ?></label>
                    ...
                    <div class="mt-5">
                        <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['specialty'] ?? 'Specialty'; ?></label>
                    ...
                    <div class="mt-5">
                        <label class="block text-sm font-medium text-gray-700 mb-1"><?php echo $t['departments']; ?></label>
